...
# Architecture-specific sources and defines
if [ "${ANDROID_ARCH}" = "arm" ]; then
    TCC_ARCH_GEN=arm-gen.c
    TCC_ARCH_LINK=arm-link.c
    TCC_TARGET_DEF=TCC_TARGET_ARM
else
    TCC_ARCH_GEN=arm64-gen.c
    TCC_ARCH_LINK=arm64-link.c
    TCC_TARGET_DEF=TCC_TARGET_ARM64
fi
